...
install -D -m 755 %{SOURCE3} %{buildroot}/%{_oneshotdir}/localsearch-reset.sh
...
add-oneshot --now --new-users --all-users localsearch-reset.sh || :
if [ "$1" -ge 1 ]; then
...
%attr(0755, -, -) %{_oneshotdir}/localsearch-reset.sh
